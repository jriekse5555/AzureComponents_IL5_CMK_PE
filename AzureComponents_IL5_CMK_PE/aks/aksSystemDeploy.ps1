...
#Azure Pre-reqs:
#- Virtual network with a subnet to hold a large number of IPs since each AKS node will have 30 IPs for its 30 pods with the default value. A /20 is recommended for a production deployment.
#- Resource Groups
